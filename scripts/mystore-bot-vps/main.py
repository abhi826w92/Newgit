...
def prompt_wizard_step_button_text(user_id, chat_id, edit_message_id=None):
    ...
    text = (
        "🔘 <b>Custom Action Button Text (Optional)</b>\n"
        "━━━━━━━━━━━━━━━━━━━━\n"
        "Customize the button label shown on the Website / PWA store:\n\n"
        "<b>Examples:</b>\n"
        "• <code>Install App</code>\n"
        "• <code>Open Web App</code>\n"
        "• <code>Join Telegram Bot</code>\n"
        "• <code>View Source Code</code>\n"
        "• <code>Play Online</code>\n\n"
...
def process_wizard_step_btn_text(message):
    ...
    if raw_text.lower() in ("skip", "none", "no", "skip skip", "pass"):
        user_states[user_id]["app_data"]["buttonText"] = ""
    else:
